...
const std::string ConfigurationUtil::CONTACTLESS_READER_NAME_REGEX = ".*ASK LoGO.*|.*Contactless.*|.*ACR122U.*";
const std::string ConfigurationUtil::CONTACT_READER_NAME_REGEX = ".*Identive.*|.*HID.*";
